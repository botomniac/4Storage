...
public class TelaCadastro extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtSenhaUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if ((!txtNomeUsuario.getText().isEmpty()) && (!txtEmailUsuario.getText().isEmpty()) && (!txtSenhaUsuario.getText().isEmpty())) {
            ...
            new File("C:\\Users\\"+System.getProperty("user.name")+"\\Desktop\\SERVER\\" + user.getNomeUsuario() + "").mkdir();
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Um ou mais campos não foram preenchidos", "ERRO", JOptionPane.ERROR_MESSAGE);
        }
