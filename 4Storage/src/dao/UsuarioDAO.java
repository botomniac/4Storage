...
public class UsuarioDAO {
	...
	public static void criaUsuario(Usuario user) {
		...
		try {
			...
			stmt.setDouble(4, user.getEspacoMax());// SETA NA COLUNA 4 O ESPAÃ‡O MAXIMO DO DISCO
			stmt.setDouble(5, user.getEspacoLivre());// SETA NA COLUNA 5 ESPAÃ‡O LIVRE NO DISCO
	...
	// A ROTINA ABAIXO Ã‰ PARA VALIDAR O LOGIN
