...
public class UsuarioDAO {
    ...
    public static void criaUsuario(Usuario user) {
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO usuario (usuario_nome,usuario_email,usuario_senha,usuario_espaco_max,usuario_espaco_livre)VALUES(?,?,?,?,?)");
    ...
    public static void criarDiretorioDeUsuario(Usuario user) {
        ...
        try {
            ...
            File diretorio = new File("C:\\Users\\" + System.getProperty("user.name") + "\\Desktop\\SERVER\\" + user.getNomeUsuario() + "");
            diretorio.mkdir();
        } catch (Exception ex) {
    ...
    public boolean checkLogin(String login, String senha) {
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM usuario WHERE usuario_nome = ? and usuario_senha = ?"); //comando para selecionar login and senha da tabela usuario
